...
def main():
    ...
    print("""
  ######################################
  # CAV3 Development Environment Setup #
  ######################################

  This script will create your CAV3 dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your CAV3 project folder:
    [Arma 3 installation directory]\\{} => CAV3 project folder
    P:\\{}                              => CAV3 project folder
